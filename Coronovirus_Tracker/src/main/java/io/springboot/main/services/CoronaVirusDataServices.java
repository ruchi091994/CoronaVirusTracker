...
public class CoronaVirusDataServices {
	...
	@PostConstruct //to call this method ones the application starts
	@Scheduled(cron = "* * 1 * * *" ) // to run on daily bases as and when the file gets updates ( second, minutes, hour, date, month, year)
